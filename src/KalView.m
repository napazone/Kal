...
- (void)addSubviewsToHeaderView:(UIView *)headerView
{
  ...
  UIImageView *backgroundView = [[UIImageView alloc] initWithImage:[UIImage kal_imageNamed:@"kal_grid_background.png"]];
  ...
  [previousMonthButton setImage:[[UIImage kal_imageNamed:@"kal_left_arrow.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateNormal];
  ...
  [nextMonthButton setImage:[[UIImage kal_imageNamed:@"kal_right_arrow.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateNormal];
...
- (void)addSubviewsToContentView:(UIView *)contentView
{
  ...
  shadowView.image = [UIImage kal_imageNamed:@"kal_grid_shadow.png"];
